...
public class GuiScreenDemo extends GuiScreen {
   ...
   public void func_73866_w_() {
      ...
      int i = -16;
      this.field_146292_n.add(new GuiButton(1, this.field_146294_l / 2 - 116, this.field_146295_m / 2 + 62 + i, 114, 20, I18n.func_135052_a("demo.help.buy", new Object[0])));
      this.field_146292_n.add(new GuiButton(2, this.field_146294_l / 2 + 2, this.field_146295_m / 2 + 62 + i, 114, 20, I18n.func_135052_a("demo.help.later", new Object[0])));
   }
