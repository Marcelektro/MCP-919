      ...
      for(int j = 0; j < 3; ++j) {
         ...
         if(this.func_146978_c(60, 14 + 19 * j, 108, 17, p_73863_1_, p_73863_2_) && k > 0 && l >= 0) {
            ...
            if(l >= 0 && Enchantment.func_180306_c(l & 255) != null) {
               ...
               list.add(EnumChatFormatting.WHITE.toString() + EnumChatFormatting.ITALIC.toString() + I18n.func_135052_a("container.enchant.clue", new Object[]{s}));
            }
            ...
            if(!flag) {
               ...
               if(this.field_146297_k.field_71439_g.field_71068_ca < k) {
                  ...
                  String s1 = "";
                  if(i1 == 1) {
                     s1 = I18n.func_135052_a("container.enchant.lapis.one", new Object[0]);
                  } else {
                     s1 = I18n.func_135052_a("container.enchant.lapis.many", new Object[]{Integer.valueOf(i1)});
                  }
                  ...
                  if(i1 == 1) {
                     s1 = I18n.func_135052_a("container.enchant.level.one", new Object[0]);
                  } else {
                     s1 = I18n.func_135052_a("container.enchant.level.many", new Object[]{Integer.valueOf(i1)});
                  }
