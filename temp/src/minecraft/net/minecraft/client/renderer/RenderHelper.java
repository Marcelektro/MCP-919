...
public class RenderHelper {
   ...
   public static void func_74519_b() {
      ...
      GL11.glLight(16384, 4609, (FloatBuffer)func_74521_a(f1, f1, f1, 1.0F));
      GL11.glLight(16384, 4608, (FloatBuffer)func_74521_a(0.0F, 0.0F, 0.0F, 1.0F));
      GL11.glLight(16384, 4610, (FloatBuffer)func_74521_a(f2, f2, f2, 1.0F));
      ...
      GL11.glLight(16385, 4609, (FloatBuffer)func_74521_a(f1, f1, f1, 1.0F));
      GL11.glLight(16385, 4608, (FloatBuffer)func_74521_a(0.0F, 0.0F, 0.0F, 1.0F));
      GL11.glLight(16385, 4610, (FloatBuffer)func_74521_a(f2, f2, f2, 1.0F));
      GlStateManager.func_179103_j(7424);
      GL11.glLightModel(2899, (FloatBuffer)func_74521_a(f, f, f, 1.0F));
   }
