      ...
      if(!World.func_175683_a(p_180655_1_, p_180655_2_.func_177977_b()) && !Blocks.field_150480_ab.func_176535_e(p_180655_1_, p_180655_2_.func_177977_b())) {
         if(Blocks.field_150480_ab.func_176535_e(p_180655_1_, p_180655_2_.func_177976_e())) {
            for(int j = 0; j < 2; ++j) {
               ...
               p_180655_1_.func_175688_a(EnumParticleTypes.SMOKE_LARGE, d3, d8, d13, 0.0D, 0.0D, 0.0D, new int[0]);
            }
         }
         ...
         if(Blocks.field_150480_ab.func_176535_e(p_180655_1_, p_180655_2_.func_177974_f())) {
            for(int k = 0; k < 2; ++k) {
               ...
               p_180655_1_.func_175688_a(EnumParticleTypes.SMOKE_LARGE, d4, d9, d14, 0.0D, 0.0D, 0.0D, new int[0]);
            }
         }
         ...
         if(Blocks.field_150480_ab.func_176535_e(p_180655_1_, p_180655_2_.func_177978_c())) {
            for(int l = 0; l < 2; ++l) {
               ...
               p_180655_1_.func_175688_a(EnumParticleTypes.SMOKE_LARGE, d5, d10, d15, 0.0D, 0.0D, 0.0D, new int[0]);
            }
         }
         ...
         if(Blocks.field_150480_ab.func_176535_e(p_180655_1_, p_180655_2_.func_177968_d())) {
            for(int i1 = 0; i1 < 2; ++i1) {
               ...
               p_180655_1_.func_175688_a(EnumParticleTypes.SMOKE_LARGE, d6, d11, d16, 0.0D, 0.0D, 0.0D, new int[0]);
            }
         }
         ...
         if(Blocks.field_150480_ab.func_176535_e(p_180655_1_, p_180655_2_.func_177984_a())) {
            for(int j1 = 0; j1 < 2; ++j1) {
               ...
               p_180655_1_.func_175688_a(EnumParticleTypes.SMOKE_LARGE, d7, d12, d17, 0.0D, 0.0D, 0.0D, new int[0]);
            }
         }
      } else {
         for(int i = 0; i < 3; ++i) {
            ...
            p_180655_1_.func_175688_a(EnumParticleTypes.SMOKE_LARGE, d0, d1, d2, 0.0D, 0.0D, 0.0D, new int[0]);
         }
      }
